...
img = cv2.imread("data/sphx_glr_plot_measure_data_001.png", cv2.IMREAD_GRAYSCALE)
...
for l in range(1, num_labels):
    if stats[l][4] > 200:
        ...
        cv2.circle(colored, (int(centers[l][0]), int(centers[l][1]), 4, (255, 0, 0), cv2.FILLED))

img = cv2.cvtColor(otsu_mask * 255, cv2.COLOR_GGRAY2BGR)
